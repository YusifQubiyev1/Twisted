...
import './FooterAvailableVehicles.modules.css';
import { Link } from 'react-router-dom';

import backgroundImage from '../../assets/images/W5I1873.jpg';
        ...
        <div className="footer-home footer-contact " style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="FooterCommissions">CONTACT MORE INFORMATION</h2>
