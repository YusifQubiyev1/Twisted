...
import './FooterModelsT.modules.css';
import { Link } from 'react-router-dom';

import backgroundImage from '../../assets/images/GFW_7268.jpg';
        ...
        <div className="footer-home" style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="ModelsTH2TAG">FIND A SHOWROOM</h2>
                    <h2 className="ModelsTH2TAG2">vehicles now shipping worldwide</h2>
                    <h2 className="ModelsTH2TAG2 ModelsTH2TAG23">contact our dealer network to review ORIGINALS.</h2>
                    <Link to="/availablevehicles" className="modelsTBTN">ENQUIRE ABOUT THE VEHICLE</Link>
                </div>
                <div className="partners-info partners-infoModelsT">
