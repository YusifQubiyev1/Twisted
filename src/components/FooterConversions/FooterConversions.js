...
import './FooterConversions.modules.css';
import { Link } from 'react-router-dom';

import backgroundImage from '../../assets/images/8-Seconds-Scotland-Surf-3.jpg';
import logoWhite from '../../assets/images/twisted-logo-copyright.png';

const FooterConversions = () => {
    return (
        <div className="footer-home footer-home-conversions" style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="FooterConversions">THIS CLOUD BE YOUR VIEW</h2>
                    <Link to="/availablevehicles" className="contact-button">SEE WHAT'S IN OUR INVENTORY</Link>
                </div>
