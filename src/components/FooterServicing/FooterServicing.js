...
import './FooterServicing.modules.css';
import { Link } from 'react-router-dom';

import backgroundImage from '../../assets/images/T40s-90-Utility-lake-scotland-GFW_8230.jpg';
import logoWhite from '../../assets/images/twisted-logo-copyright.png';

const FooterServicing = () => {
    return (
        <div className="footer-home footer-contact " style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="FooterServicing">SEE WHAT'S IN OUR GARAGE</h2>
                    <Link to="/availablevehicles" className="contact-button">EXPLORE THE INVENTORY</Link>
                </div>
