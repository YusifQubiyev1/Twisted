...
import './FooterAbout.modules.css';
...
const FooterAbout = () => {
    return (
        <div className="footer-home footer-contact " id="footerabout" style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="FooterCommissions">CONTACT DEALER NEAR YOU</h2>
