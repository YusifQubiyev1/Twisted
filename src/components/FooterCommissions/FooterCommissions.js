...
import './FooterCommissions.modules.css';
import { Link } from 'react-router-dom';

import backgroundImage from '../../assets/images/footer-bg-commissions.jpg';
import logoWhite from '../../assets/images/twisted-logo-copyright.png';

const FooterCommissions = () => {
    return (
        <div className="footer-home footer-contact " style={{ backgroundImage: `url(${backgroundImage})` }}>
            <div className="footer-content">
                <div className="contact-dealer">
                    <h2 className="FooterCommissions">BEGIN YOUR JOURNEY TODAY</h2>
